        ...
        <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
          {[...Array(5)].map((_, i) => (
            <motion.div
              ...
              transition={{ duration: 9 + i * 2, repeat: Infinity, delay: i * 1.4, ease: "easeInOut" }}
              className="absolute bottom-0 rounded-full bg-cyan-400/30 blur-3xl"
              style={{ width: `${80 + i * 20}px`, height: `${80 + i * 20}px`, left: `${8 + i * 18}%` }}
            />
          ))}
        </div>
              ...
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-cyan-400/20 to-blue-600/20 border border-cyan-400/20 mb-4">
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
                  <path
                    ...
                    stroke="#38bdf8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none"
                  />
                </svg>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                <label className="text-xs text-slate-400 uppercase tracking-widest font-medium flex items-center gap-2">
                  <Mail className="w-3.5 h-3.5 text-cyan-400/70" /> Email Address
                </label>
                <input
                  type="email"
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  />
                  <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-500 hover:text-cyan-400 transition-colors">
