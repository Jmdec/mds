  ...
  useEffect(() => {
    const fetchServices = async () => {
      ...
      try {
        ...
        const services: RawService[] = data.data || []
        ...
        const formattedServices: Service[] = services.map((s) => ({
          ...
          image: s.image
            ...
            : "/__generating__/img_198b4f32d1d8.png",
          status: s.status,
          category: s.category,
          price: s.price,
        }))

        setDentalServices(formattedServices.filter((s) => s.category === "Dental"))
        setAestheticServices(formattedServices.filter((s) => s.category === "Aesthetic"))
      } catch (error) {
  ...
  return (
    <div className="font-sans">
      ...
      <section
        ...
        style={{ background: "linear-gradient(135deg, #03091A 0%, #071535 60%, #0A1F4E 100%)" }}
      >
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          <motion.div {...fade}>
            ...
            <div className="flex items-center justify-center gap-3 mb-6">
              <div className="h-px w-16" style={{ background: "linear-gradient(to right, transparent, #3B82F6)" }} />
              <div className="w-1.5 h-1.5 rounded-full bg-blue-400" />
              <div className="h-px w-16" style={{ background: "linear-gradient(to left, transparent, #3B82F6)" }} />
            </div>

            <p className="text-base md:text-lg max-w-2xl mx-auto" style={{ color: "#94A3B8" }}>
              Comprehensive dental and aesthetic services, each precision-engineered for measurable results.
            </p>
          </motion.div>
        </div>
      </section>
                ...
                items.map((s) => (
                  ...
                  >
                    <div
                      ...
                      onMouseEnter={(e) => {
                        e.currentTarget.style.boxShadow = "0 8px 32px rgba(37,99,235,0.16), 0 0 0 1px #93C5FD"
                    ...
                    >
                      ...
                      <div className="h-48 overflow-hidden relative">
                        ...
                        <div
                          ...
                          style={{
                            background: "linear-gradient(180deg, transparent 40%, rgba(29,78,216,0.18) 100%)",
                          }}
                        />
                      </div>
                      ...
                      <div className="p-6 flex flex-col flex-1">
                        ...
                        <h3 className="font-serif text-xl mb-2 leading-snug" style={{ color: "#0F172A" }}>
                          {s.title}
                        </h3>
      ...
      >
        <div className="pointer-events-none absolute inset-0">
          <div
            ...
            style={{
              background: "radial-gradient(ellipse 80% 60% at 50% 50%, rgba(37,99,235,0.12) 0%, transparent 70%)",
            }}
          />
        ...
        <motion.div {...fade} className="relative max-w-3xl mx-auto px-6 text-center">
          <div className="flex items-center justify-center gap-3 mb-8">
            <div className="h-px w-12" style={{ background: "linear-gradient(to right, transparent, #3B82F6)" }} />
            <div className="w-1.5 h-1.5 rounded-full bg-blue-400" />
            <div className="h-px w-12" style={{ background: "linear-gradient(to left, transparent, #3B82F6)" }} />
          </div>
          ...
          <p className="mb-10 text-base" style={{ color: "#94A3B8" }}>
            Our specialists will design a personalized treatment plan during your consultation.
          </p>
